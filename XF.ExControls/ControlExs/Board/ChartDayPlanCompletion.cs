...
{
    public partial class ChartDayPlanCompletion : UserControl
    {
        #region 自定义变量
        #region 图表
        //图表
        ...
        public void InitChart()
        {
            ...
            for (int i = 0; i < 4; i++)
            {
                for (int j = 0; j < 31; j++)
                {
                    //listlistDataPoint[i].Add(new DataPoint(j + 1, Convert.ToDecimal(Math.Round(rd.Next(80, 99) + (double)rd.NextDouble(), 1)).ToString()));
            ...
            series2.Color = Color.Yellow;//Color.FromArgb(255, 237, 125, 49);//Color.Blue;//System.Drawing.Color.FromArgb(((int)(((byte)(220)))), ((int)(((byte)(65)))), ((int)(((byte)(140)))), ((int)(((byte)(240)))));
            series2.Legend = "Default";
            series2.MarkerSize = 8;
            series2.MarkerStyle = System.Windows.Forms.DataVisualization.Charting.MarkerStyle.Circle;
            series2.Name = "自动1线 NM1-63";
            ...
            series3.Color = Color.Gray;//Color.FromArgb(255, 237, 125, 49);//Color.Blue;//System.Drawing.Color.FromArgb(((int)(((byte)(220)))), ((int)(((byte)(65)))), ((int)(((byte)(140)))), ((int)(((byte)(240)))));
            series3.Legend = "Default";
            series3.MarkerSize = 8;
            series3.MarkerStyle = System.Windows.Forms.DataVisualization.Charting.MarkerStyle.Diamond;
            series3.Name = "自动2线 NXM-160";
            ...
            series4.Color = Color.FromArgb(255, 237, 125, 49);//Color.Blue;//System.Drawing.Color.FromArgb(((int)(((byte)(220)))), ((int)(((byte)(65)))), ((int)(((byte)(140)))), ((int)(((byte)(240)))));
            series4.Legend = "Default";
            series4.MarkerSize = 8;
            series4.MarkerStyle = System.Windows.Forms.DataVisualization.Charting.MarkerStyle.Triangle;
            series4.Name = "自动2线 NM-125";
        ...
        #endregion
        #region 2条产线4个产品类型的达成率显示
        public void Show4Product(bool bShowProduct1 = true, bool bShowProduct2 = true, bool bShowProduct3 = true, bool bShowProduct4 = true)
        {
            bShowSeries[0] = bShowProduct1;
            bShowSeries[1] = bShowProduct2;
            bShowSeries[2] = bShowProduct3;
            bShowSeries[3] = bShowProduct4;
            Chart1.Series.Clear();
            if (bShowProduct1)
            {
                Chart1.Series.Add(series1);
        ...
        #endregion
        #region 更改某条线的名字
        public void ChangeProductName(int index, string sName)
        {
            try
            {
                switch (index)
        ...
        #endregion
        #region 更改某一个产品某一天的达成率
        public void ChangeProductDayCompletion(int iProduct, int iDay, decimal dValue)
        {
            listlistDataPoint[iProduct][iDay].SetValueXY(iDay + 1, dValue);
        }
        #endregion
        #region 更改某一天4个产品的达成率
        public void ChangeDayCompletion(int iDay, decimal dValue1, decimal dValue2, decimal dValue3, decimal dValue4)
        {
            ChangeProductDayCompletion(iDay, 0, dValue1);
            ChangeProductDayCompletion(iDay, 1, dValue2);
            ChangeProductDayCompletion(iDay, 2, dValue3);
            ChangeProductDayCompletion(iDay, 3, dValue4);
        }
        #endregion
        #region 更改某一产品所有天的达成率
        public void ChangeProductCompletion(int iProduct, decimal[] arrValues)
        {
            for (int i = 0; i < (arrValues.Length > 31 ? 31 : arrValues.Length); i++)
                ChangeProductDayCompletion(iProduct, i, arrValues[i]);
        }
        #endregion
        #region 更改4个产品所有天的达成率
        public void ChangeCompletion(decimal[] arrValues1, decimal[] arrValues2, decimal[] arrValues3, decimal[] arrValues4)
        {
            for (int i = 0; i < (arrValues1.Length > 31 ? 31 : arrValues1.Length); i++)
                ChangeProductDayCompletion(0, i, arrValues1[i]);
            for (int i = 0; i < (arrValues2.Length > 31 ? 31 : arrValues2.Length); i++)
                ChangeProductDayCompletion(1, i, arrValues2[i]);
            for (int i = 0; i < (arrValues3.Length > 31 ? 31 : arrValues3.Length); i++)
                ChangeProductDayCompletion(2, i, arrValues3[i]);
            for (int i = 0; i < (arrValues4.Length > 31 ? 31 : arrValues4.Length); i++)
                ChangeProductDayCompletion(3, i, arrValues4[i]);
        }
        #endregion

        private void ChartDayPlanCompletion_Load(object sender, EventArgs e)
        {
            bShowSeries[0] = true;
            bShowSeries[1] = true;
            bShowSeries[2] = true;
