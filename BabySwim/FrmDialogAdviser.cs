...
namespace BabySwim
{
    public partial class FrmDialogAdviser : XFFormEx
    {
        int teacherid;
        string teachercode;
        string teachername;
        ...
        public FrmDialogAdviser()
        {
            InitializeComponent();
            dataGridView1.AutoGenerateColumns = false;
        }

        public FrmDialogAdviser(string teacher)
        {
            InitializeComponent();
        ...
        private void BindData()
        {
            ...
            strWhere = zDataConverter.AppendSQL(strWhere, " and A.TeacherType = 1 ");
