...
namespace WeChat.Quartz
{
    public class ScheduleCenter
    {
        ...
        /// <returns></returns>
        public async Task<BaseResult> AddJobAsync(String JobName, String JobGroup, String JobNamespaceAndClassName, String JobAssemblyName, string CronExpress)
        {
        ...
        /// <param name="jobGroup">任务分组</param>
        /// <returns></returns>
        public async Task<BaseResult> StopJobAsync(string jobName, string jobGroup)
        {
            BaseResult result = new BaseResult();
            try
            {
        ...
        /// <returns></returns>
        public async Task<BaseResult> ResumeJobAsync(string jobName, string jobGroup)
        {
            BaseResult result = new BaseResult();
            try
            {
        ...
        /// <param name="jobGroup">任务组</param>
        /// <returns></returns>
        public async Task<BaseResult> DeleteJobAsync(string jobName, string jobGroup)
        {
            BaseResult result = new BaseResult();
            try
            {
