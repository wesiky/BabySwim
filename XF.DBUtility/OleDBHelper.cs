...
namespace XF.DBUtility
{
    public abstract class OleDBHelper
    {
        ...
        public static string connectionString = "Provider=Microsoft.Jet.OLEDB.4.0;Persist Security Info=False;Data Source=" + System.Web.HttpContext.Current.Server.MapPath(ConfigurationManager.AppSettings["SQLString"]);
        ...
        public static void ExecuteMulti_Sql(ArrayList SQLStringList)
        {
